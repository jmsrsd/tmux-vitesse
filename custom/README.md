...
```sh
set -g @vitesse_status_modules "... <module_name> ..."
...
show_<module_name>() { # save this module in a file with the name <module_name>.sh
  ...
  local icon="$(get_tmux_option "@vitesse_<module_name>_icon" "<Use an icon from [nerdfonts](https://www.nerdfonts.com/cheat-sheet)>")"
  local color="$(get_tmux_option "@vitesse_<module_name>_color" "<Use one of the default theme colors (ex: $thm_orange), or provide a color code (ex: #ef9f76)>")"
  local text="$(get_tmux_option "@vitesse_<module_name>_text" "<Provide the text that you want to be displayed>")"
